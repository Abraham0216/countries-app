...
function App() {
  ...
  return (
    <appContext.Provider value={{responseData, filteredCountries, handleCountryClick, setSelectedCountry, selectedCountry, searchTerm, setSearchTerm, selectedRegion, setSelectedRegion,handleSearchChange, handleRegionChange, isDark}}>
    <div className={`App min-h-screen   transition-all duration-500 ease-in-out ${isDark && 'bg-veryDarkBlue'}`}>
